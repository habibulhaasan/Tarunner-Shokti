...
import FundAccountsPanel from "../../components/admin/FundAccountsPanel";
import FundReviewPanel from "../../components/admin/FundReviewPanel";
        ...
        {view === "settings" ? (
          ...
          <div className="admin-settings-view">
            <div className="pill-group" style={{ marginBottom: 18 }}>
              <button type="button" className={`pill ${fundView === "review" ? "active" : ""}`} onClick={() => setFundView("review")}>
                Review submissions
              </button>
              <button type="button" className={`pill ${fundView === "expenses" ? "active" : ""}`} onClick={() => setFundView("expenses")}>
                Expenses
              </button>
              <button type="button" className={`pill ${fundView === "ledger" ? "active" : ""}`} onClick={() => setFundView("ledger")}>
                Ledger
              </button>
              <button type="button" className={`pill ${fundView === "accounts" ? "active" : ""}`} onClick={() => setFundView("accounts")}>
                Accounts &amp; visibility
              </button>
            </div>
            {fundView === "review" ? <FundReviewPanel /> : fundView === "expenses" ? <FundExpensesPanel /> : fundView === "ledger" ? <FundLedgerPanel /> : <FundAccountsPanel />}
          </div>
        ) : (
          <>

...
/** IHT-type facilities only, for the student/institute picker (EmploymentStep). */
export const INSTITUTES = HOSPITALS.filter((h) => h.facilityType === "Institute of Health Technology");

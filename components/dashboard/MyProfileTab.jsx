    ...
    <div>
      <div className="profile-header">
        ...
        {!editing && (
          <div className="profile-header-actions">
            <Link href={`/id-card/${user.uid}`} target="_blank" className="btn-ghost btn" style={{ width: "auto" }}>
              <CreditCard size={14} style={{ verticalAlign: "-2px", marginRight: 6 }} />
              আইডি কার্ড
            </Link>
      ...
      <div className="profile-section">
        ...
        <div className="profile-info-grid">
          ...
          <InfoRow label="Permanent address" value={getLocationLabel(profile.permanentAddress?.upazilaId, "bn")} />
      ...
      <div className="profile-section">
        ...
        {editing ? (
          ...
          <div className="profile-info-grid">
            <InfoRow label="Current address" value={getLocationLabel(profile.currentAddress?.upazilaId, "bn")} />
